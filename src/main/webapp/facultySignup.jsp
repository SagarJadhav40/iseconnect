...
<body>
			...
			<div class="row g-3">
				...
				<div class="col-md-6">
					<label for="confirm" class="form-label">Confirm Password</label> <input
						type="password" class="form-control" name="confirm" required>
				</div>
				<div class="col-md-6">
					<label for="mobile" class="form-label">Mobile</label> <input
						type="tel" class="form-control" name="mobile" required>
				</div>
				<div class="col-md-6">
				...
				<div class="col-12">
					<label for="securityAnswer" class="form-label">Security
	...
	<footer class="footer">&copy; 2025 ISE Department. All rights
		reserved.</footer>
