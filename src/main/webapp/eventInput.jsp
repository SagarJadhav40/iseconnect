...
<head>
  <meta charset="UTF-8">
  <title>ISE CONNECT - Add Event Certification</title>
    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="form-container">
          <h4 class="text-center mb-4 form-heading">Add Event Certification</h4>
          <form id="nptelForm" action="AddNptel" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
              <input type="hidden" value="event" name="type">
              <label for="courseName" class="form-label">Event Name(With Department Organised in '()')</label>
              <input type="text" class="form-control" id="courseName" name="courseName" placeholder="Enter Event Name" required>
            </div>
            <div class="mb-3">
              <label for="courseDuration" class="form-label">Event Duration</label>
              <input type="text" class="form-control" id="courseDuration" name="courseDuration" placeholder="e.g., 2 days" required>
            </div>
            <div class="mb-3">
