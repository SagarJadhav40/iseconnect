...
<head>
  <meta charset="UTF-8">
  <title>ISE CONNECT - Add Faculty Development Program</title>
...
<nav class="navbar navbar-expand-lg" style="background-color: var(--blue-dark);">
    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="form-container">
          <h4 class="text-center mb-4 form-heading">Add Faculty Development Program</h4>
          <form id="fdpForm" action="AddNptel" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
              <input type="hidden" value="fdp" name="type">
              <label for="programTitle" class="form-label">Program Title</label>
              <input type="text" class="form-control" id="programTitle" name="courseName" placeholder="Enter Program Title" required>
            </div>
            <div class="mb-3">
              <label for="numberOfDays" class="form-label">Number of Days</label>
              <input type="number" class="form-control" id="numberOfDays" name="courseDuration" placeholder="Enter Number of Days" min="1" required>
            </div>
            <div class="mb-3">
  ...
  <script>
    document.getElementById('fdpForm').addEventListener('submit', function (e) {
      const programTitle = document.getElementById('programTitle').value.trim();
